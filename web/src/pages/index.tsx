...
import appImg from '../assets/app-nlw-copa.png'
...
export default function Home({poolCount, guessCount, userCount}: HomeProps) {
  ...
  async function createPool(e: FormEvent) {
    ...
    try{
      ...
      alert(`Bolão com o código ${code} foi criado com sucesso! O código foi copiado para a área de transferência.`)
      setPoolTitle('')
    }catch(err) {
      console.log(err)
  ...
  return (
    <div className='max-w-[1124px] h-screen mx-auto grid grid-cols-2 items-center gap-28'>
      ...
      <Image src={appImg} alt="Dois celulares exibindo uma prévia do app móvel" />
    </div>
  )
}
